...
Item {
    ...
    function isHiddenSystemItem(item) {
        ...
        return blob.includes("bluetooth")
            || blob.includes("blueman")
            || blob.includes("network")
            || blob.includes("nm-applet")
            || blob.includes("wifi")
    ...
    GridLayout {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                readonly property bool hiddenByPolicy: root.isHiddenSystemItem(modelData)
                visible: !hiddenByPolicy
                implicitWidth: hiddenByPolicy ? 0 : 20
                implicitHeight: 20
