...
# This script is deprecated and kept for compatibility with older plugin workflows.

# Config

INSTALL_DIR="$HOME/.config/hype/plugins"
CACHE_BASE="/tmp/hype-plugins"

declare -A PLUGIN_REPOS=(
  [official]="${HYPE_PLUGINS_REPO:-https://github.com/morph/hype-plugins.git}"
)
...
requires_hype: \(.requires_hype // "none")
repo: '"$repo"'
---"
      ' "$dir/manifest.json"
    done
