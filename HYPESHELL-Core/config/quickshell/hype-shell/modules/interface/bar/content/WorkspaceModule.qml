...
Item {
    ...
    property int numWorkspaces: ThemeOverrides.get("bar.modules.workspaces.workspaceIndicators", Config.runtime.bar.modules.workspaces.workspaceIndicators)
    ...
    implicitHeight: ThemeOverrides.get("bar.modules.height", Config.runtime.bar.modules.height)
        ...
        RowLayout {
            ...
            Repeater {
                ...
                Item {
                    ...
                    StyledText {
                        anchors.centerIn: parent
                        visible: ThemeOverrides.get("bar.modules.workspaces.showJapaneseNumbers", Config.runtime.bar.modules.workspaces.showJapaneseNumbers) && !Config.runtime.bar.modules.workspaces.showAppIcons
