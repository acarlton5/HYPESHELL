...
Rectangle {
    ...
    ColumnLayout {
        visible: Config.runtime.appearance.lockscreen.showClock
        ...
        // Digital Clock (Matches SDDM Style)
        Item {
            id: digitalClockContainer
            visible: !Config.runtime.appearance.background.clock.isAnalog || !Config.runtime.appearance.background.clock.enabled
            width: 450
            height: 250
            ...
            Column {
                ...
                StyledText {
                    ...
                    font.pixelSize: Metrics.fontSize(156)
                    font.bold: true
        ...
        // Analog Clock (Matches SDDM Style)
        Item {
            ...
            visible: Config.runtime.appearance.background.clock.enabled && Config.runtime.appearance.background.clock.isAnalog
            width: 350
            height: 350

            // Polygon (Matches Gadget Style)
            MorphedPolygon {
                id: shapeCanvas
            ...
            // Simple Circle Border (Optional overlay for consistency with SDDM border)
            Rectangle {
                anchors.fill: parent
                radius: width / 2
                color: "transparent"
