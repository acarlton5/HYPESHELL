...
PanelWindow {
    id: sidebarRight
    WlrLayershell.namespace: "hype:sidebarRight"
    WlrLayershell.layer: WlrLayer.Top
    visible: Config.initialized && Globals.visiblility.sidebarRight && !Globals.visiblility.sidebarLeft && !Globals.visiblility.sidebarDev
    color: "transparent"
    exclusiveZone: 0
