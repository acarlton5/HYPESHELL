...
Singleton {
    ...
    property string shellConfig: FileUtils.trimFileProtocol(`${Directories.config}/hype`)
    ...
    property string generatedMaterialThemePath: FileUtils.trimFileProtocol(`${Directories.config}/hype/config/colors.json`)
    ...
    Component.onCompleted: {
        ...
        Quickshell.execDetached(["mkdir", "-p", `${shellConfig}/gadgets`])
        Quickshell.execDetached(["mkdir", "-p", `${shellConfig}/modules`])
