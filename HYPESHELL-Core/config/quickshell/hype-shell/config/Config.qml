        ...
        JsonAdapter {
            ...
            property JsonObject plugins: JsonObject {
                property JsonObject mediaPlayer: JsonObject {
                    ...
                    property int peekDurationMs: 5000
                }
            }
            ...
            property JsonObject appearance: JsonObject {
                ...
                property JsonObject background: JsonObject {
                    ...
                    property url path: "file://" + Directories.home + "/.config/quickshell/hype-shell/defaults/default.jpg"
            ...
            property JsonObject shell: JsonObject {
                property string version: "0.7.18"
            ...
            property JsonObject modules: JsonObject {
                property JsonObject dssSystems: JsonObject {
                    property bool enabled: true
                }
                property JsonObject dssWorkspace: JsonObject {
                    property bool enabled: false
                }
            }
