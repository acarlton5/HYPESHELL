...
PanelWindow {
    ...
    LazyLoader {
        id: fullPanelLoader
        active: Globals.visiblility.dssFullPanelOpen && Config.initialized

        Loader {
            source: Qt.resolvedUrl("../dssWorkspace/DssFullPanel.qml")
            onLoaded: {
                item.systemUrl = Config.runtime.modules.dssWorkspace.systemUrl || "http://localhost:3001/"
            }
        }
    }
}
